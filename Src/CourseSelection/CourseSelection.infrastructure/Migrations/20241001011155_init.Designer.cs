...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnitSelection.Domain.ReserveUnits.ReserveUnits", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReserveUnits", "UnitsSelection");
                });

            modelBuilder.Entity("UnitSelection.Domain.Units.Units", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Units", "UnitsSelection");
                });

            modelBuilder.Entity("UnitSelection.Domain.courses.Courses", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Courses", "UnitsSelection");
                });
            ...
            modelBuilder.Entity("CourseSelection.Domain.Units.Units", b =>
                {
                    b.HasOne("UnitSelection.Domain.courses.Courses", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CourseSelection.Domain.Course.Courses", null)
                        .WithMany("Units")
            ...
            modelBuilder.Entity("UnitSelection.Domain.ReserveUnits.ReserveUnits", b =>
                {
                    b.HasOne("UnitSelection.Domain.Units.Units", "Units")
                        .WithMany("ReserveUnits")
